...
const GOOGLE_API_KEY = "AIzaSyCEEj84WG__AV1saAlfU_qkYEeyBQHfhxA";
const API_REQUEST_URL = `https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${GOOGLE_API_KEY}`;
